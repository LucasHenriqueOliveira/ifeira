...
export default function Home() {
  ...
  const handleChangeUf = (uf) => {
    ...
    api.get("regioes/municipios/" + uf.toLocaleLowerCase()).then((response) => {
      setCities(response);
    });
  ...
  const handleChangeCity = (city) => {
    ...
    api.get("regioes/bairros/" + city.toLocaleLowerCase()).then((response) => {
    ...
    let response = [
      {
        ...
        produtos: ["legumes", "frutas nacionais", "frutas importadas"],
        tipos: ["orgânicos", "não orgânicos"],
        bairrosEntrega: ["Jardins", "Vila Mariana", "Moema"],
